...
def calc_run(run_dir,
        ...
        meas = short_meas,):
    if not log_file in os.listdir(run_dir):
        return
...
path = "G:/Prive/MIJN-Documenten/TU/62-Stage/20180104-100hz/" # directory with subdirectories with measurements
...
for dir in dirs:
    ...
    if os.path.isdir(run_dir):
        ...
        calc_run(run_dir, meas=meas, scope_file_name_index=0)

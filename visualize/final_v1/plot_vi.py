...
def plot_vi(data, reactor):
    ...
    save_file(fig, name='vi-'+reactor, path='G:/Prive/MIJN-Documenten/TU/62-Stage/05_python/plots_final_v1')
...
def plot_vi_zoom(data, reactor):
    ...
    save_file(fig, name='vi-zoom-' + reactor, path='G:/Prive/MIJN-Documenten/TU/62-Stage/05_python/plots_final_v1')
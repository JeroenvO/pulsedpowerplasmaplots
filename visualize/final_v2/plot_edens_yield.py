...
def plot_edens_yield(data, reactor):
    ...
    for line in data:
        ...
        ax[2].scatter(edens, line['output_p_avg'], label=l, c=c, marker=m)
    ...
    lgd2 = ax[2].legend(handles=marker_legends, loc='upper left')
    ...
    save_file(fig, name='edens-'+reactor, path='plots_final')
